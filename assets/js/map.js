...
const athensMarkers = [{
    // https://www.timeout.com/athens/restaurants/best-restaurants-in-athens & https://klimataria.gr/
                ...
                iconImage: 'http://maps.google.com/mapfiles/kml/shapes/dining.png',
                content: '<h3>Klimataria</h3> <p>For traditional Greek food, music and dance. This family-run taverna has been going strong since 1927, offering evenings packed with Mediterranean food, music and dance – a combination Greeks love. The tis oras – a grilled meat platter – is what you should go for. It includes biftekia, grilled meat patties seasoned with spices, as well as lamb and pork chops. Plus, considering Klimataria translates as ‘grape vines’, it’s no surprise the wine served here is always excellent. </p><a href="https://klimataria.gr/">klimataria.gr</a>'
            }, {    
                ...
                iconImage: 'http://maps.google.com/mapfiles/kml/shapes/lodging.png',
                content: '<h3>Electra Metropolis</h3><p></p><a href="https://www.booking.com/hotel/gr/electra-metropolis.en-gb.html?aid=356980;label=gog235jc-1DCAIoXDgbSAlYA2hQiAEBmAEJuAEXyAEM2AED6AEB-AECiAIBqAIDuAKVm_n-BcACAdICJDM3OTQ4NTcxLWIxN2UtNDhmNi1iZjQwLTJmNjdkMDFlNGMyNdgCBOACAQ;sid=8f5d6c7740e4b688a551571a0ae3738e;dest_id=-814876;dest_type=city;dist=0;group_adults=2;group_children=0;hapos=1;hpos=1;no_rooms=1;room1=A%2CA;sb_price_type=total;sr_order=popularity;srepoch=1608404391;srpvid=8e738593300601c6;type=total;ucfs=1&#hotelTmpl">View on Booking.com</a>'
            }, 
        {           
            ...
            }, 
        {
            // https://www.thecrazytourist.com/15-best-things-to-do-in-sibiu-romania/
                ...
                iconImage: 'http://maps.google.com/mapfiles/kml/shapes/target.png',
                content: '<h3>Bridge of Lies</h3><p>Linking two halves of the Small Square is Romania’s oldest iron bridge. The Bridge of Lies was cast in 1859 and soon became another emblem for Sibiu. It got its memorable name by a quirk of language because in German the words for “to lie” and “to lie (tell untruths)” are similar. The bridge was called the “Lying Bridge” as it has no standing supports and instead rests on two embankments. But soon, thanks to oral tradition the structure got its own legends. The most famous goes that the bridge will collapse of someone sits on it and tells a lie. What is true is that it’s an elegant piece of design, with Neo-Gothic motifs in its ironwork and four wrought iron gas lights on pedestals at each corner.</p><a href=""></a>'
            }, ];
        ...
        // http://restoran-lovorka.incroatia.info/en/kontakt.html
            const rijekaMarkers = [{
                ...
                iconImage: 'http://maps.google.com/mapfiles/kml/shapes/dining.png',
                content: '<h3>Grill Lovorka</h3><p>A carnivore’s paradise, Grill Lovorka cooks up traditional Balkan and Croatian cuisine with a special focus on barbecued meats.</p><a href="http://restoran-lovorka.incroatia.info/en/kontakt.html">Visit their website</a>'
            }, {
